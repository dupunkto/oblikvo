...
export function willHit(
  ...
  t1 =
    (entity.position.x - entity.dimensions.x / 2 - origin.x) * invDirection.x;
  t2 =
    (entity.position.x + entity.dimensions.x / 2 - origin.x) * invDirection.x;
  ...
  t1 =
    (entity.position.y - entity.dimensions.y / 2 - origin.y) * invDirection.y;
  t2 =
    (entity.position.y + entity.dimensions.y / 2 - origin.y) * invDirection.y;
  ...
  t1 =
    (entity.position.z - entity.dimensions.z / 2 - origin.z) * invDirection.z;
  t2 =
    (entity.position.z + entity.dimensions.z / 2 - origin.z) * invDirection.z;
