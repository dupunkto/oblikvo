...
class Entity implements CommonEntity {
  ...
  constructor(p5: p5, entity: CommonEntity) {
    ...
    this.acceleration = toVector(entity.acceleration);
  ...
  public draw(assets: Map<string, any>, _towards: p5.Vector) {
    // TODO(msb): this isn't working, it's placing entities at
    // the wrong coords.
